...
%%
%%
\section{Direkte (wörtliche) Zitate}\label{sec:citations:direct}
%
...
%%
%%
\section{Indirekte (sinngemäße) Zitate}\label{sec:citations:indirect}
%
...
%%
%%
\section{Zitieren von fremdsprachlichen Texten}\label{sec:citations:forgein_languages}
%
...
%%
%%
\section{Zitieren von Wikipedia}\label{sec:citations:wikipedia}
%
...
%%
%%
\section{Plagiate}\label{sec:citations:plagiarism}
%
...
%%
\subsection{Die rechtlichen Folgen eines Plagiats?}\label{sec:citations:plagarism:law}
%
