...
%\renewcommand{\sectionmark}[1]{\markright{\thesection~#1}} % Uncomment when using the twoside option - this modifies the header on odd pages
...
\setcounter{tocdepth}{2} % Set the depth of the table of contents to show sections and sections only
