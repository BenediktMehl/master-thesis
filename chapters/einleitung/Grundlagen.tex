...
Um den Ablauf besser zu verstehen ist in Abbildung \ref{fig:squarify_example_gif} ein Video eingebettet, das die ersten zwei Schritte des Algorithmus zeigt. Es ist zu erkennen, wie das einfügen der Rechtecke die Reihen breiter macht und wie das letzte Rechteck in der Reihe entfernt wird, da es das schlechteste Seitenverhältnis verschlechtert.
