...
Es wird zusätlich noch zwischen echter 3D-Visualisierung und sogenannten 2.5D-Visualisierungen unterschieden. Eine 2.5D Visualisierung nutzt zwar drei Dimensionen, die dritte Dimension wird jedoch nur eingeschränkt verwendet~\cite{wikipedia2.5D}. 2.5D Visualisierungen entstehen durch ein 2D-Layout, das um eine dritte Dimension erweitert wird. Zum beispiel wäre ein 2D-Raum-Layout, welches nach oben extrudiert wird, eine 2.5D-Visualisierung. Echte 3D-Visualisierungen hingegen nutzen alle drei Dimensionen vollständig aus, indem Objekte frei im dreidimensionalen Raum positioniert werden können, zum Beispiel wäre eine ein Modell des Sonnensystems, bei dem die Planeten frei im Raum positioniert sind, eine echte 3D-Visualisierung.
