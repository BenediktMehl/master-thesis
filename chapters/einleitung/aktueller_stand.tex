...
%Idee: viele geschachtelte order einfach zusammenfügen, wenn sonst keine files enthalten sind
%variable offsets, je nach größe des elternknotens oder schachtelungs tiefe