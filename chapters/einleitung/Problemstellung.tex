...
\section{Evaluationsrahmen} \label{sec:Evaluationsrahmen}
...
%nicht interaktiv, weil nicht überfordern und super simple - es soll keine interaktion nötig sein
%farben nur für die ordner strukturen - also nicht komplett ohne farben

%2.5D muss nochmal klarer definiert werden
%außerdem erkläre den intermediate step, der zum filtern benutzt werden wird


%johnson1993treemapsPhd seite 32: Although no single tool will be appropriate for every data set and every task, treemaps are a powerful tool to add to the existing collection the hierarchical data analysis tools.