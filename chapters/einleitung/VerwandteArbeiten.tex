...
\begin{figure}
    ...
    \caption{Beispiel für Layouts, die durch Splitting (links) und Packing (rechts) Algorithmen erzeugt wurden. Bei Packing-Algorithmen entsteht mehr Platz zwischen den Knoten~\cite[3]{scheibel2020survey}.}
...
\begin{figure}
    ...
    \caption{Links: Nested-Treemap-Ansatz mit vollständiger Verschachtelung. Rechts: Cascaded-Treemap-Ansatz nach~\cite[3]{lu2008cascaded} mit versetzten Kindknoten.}
    \label{fig:cascaded}
\end{figure}
