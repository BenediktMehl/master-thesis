...
In der Analyse wurden viele unnötig komplexe Funktionen gefunden: sehr lange Methoden, stark verschachtelte Strukturen, fehlende Guard-Clauses und kaum Hilfsfunktionen. Moderne Sprachfeatures wie Switch(-Expressions) oder Pattern Matching werden selten genutzt, sodass Logik oft unstrukturiert in großen Funktionen zusammengefasst ist. Dies zeigt sich deutlich an der hohen zyklomatischen Komplexität einiger Dateien. Manche wenige Dateien sind sogar extrem komplex (über 200).
