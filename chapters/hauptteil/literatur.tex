...
Das Ziel dieses Abschnitts ist es 2D-Layouts zu finden, die geeignet sind, um extrudiert zu werden und Software-Qualitätsmetriken in Form der in Abschnit \ref{sec:Problemstellung} definierten Form in 2.5D zu visualisieren.
...
Im ersten Abschnitt stellen wir zunächst die Methodik vor, die wir bei der Recherche verwendet haben. Anschließend stellen wir die Ergebnisse der Recherche vor. Danach stellen wir die Layouts vor, für die sich entschieden wurde.
...
sie müssen zunächst in einem layout schritt in die zuvor definierte form gebracht werden: \ref{lst:nodeLayoutSchema}
Dann müssen sie in einem extrusionsschritt sinnvoll in 2.5D form gebracht werden könnenf
