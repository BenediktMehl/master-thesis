...
Finde Ordner, die viele Blobs enthaltenen
Finde Ordner, die viele Dateien enthalten
Finde Ordner, die schlechte Hohe metrik
Finde Ordner, die schlechte Farbe metrik

Wie würdest du die Qualität dieser Software bewerten?

Bild von oben, welches ist der größte Ordner?

Tiefe nesting level finden

Dateien mit falschen namen in falschen ordnern

outliers finden

duplikate finden anhand von struktur oder name oder farbe

Selbe grundfäche mit verschiedenen metriken zeigen und schauen, ob noch eine korrelation hergestellt werden kann
...
%korrelation mit dem Code schwer direkt zu fragen, ohne codebase zu zeigen.
