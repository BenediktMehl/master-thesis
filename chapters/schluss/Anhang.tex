...
Die folgende Implementierung orientiert sich an der Referenzimplementierung des Squarify-Algorithmus in der JavaScript-Bibliothek d3.js~\cite{d3_treemap_github}. Sie enthält gezielte Optimierungen für eine leistungsfähigere Berechnung und folgt daher nicht in allen Details der Beschreibung in den Grundlagen.
