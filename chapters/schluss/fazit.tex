...
Gehe auf das Potenzial von nicht getesteten Ansätzen ein zb bubble treemaps, könnte sehr cool sein

In der suche haben wir viele verschiedene Ansätze vorgestellt, die auch verschieden fokus haben, zum beispiel auf die darstellung von gebäuden, interessant auch das zu vergleichen

Es wäre interessant alle aspekte zu vergleich, also auch detail grad, farben, ....

Man könnte nochmal die Kriterien spezifisch testen

Es wäre interessant heraus zu finden, warum 1,05 als zielwert besser als 1 ist.

Noch mehr die MehrfacheBerechnung austesten

interessant wäre eine noch größere Umfrage

codecharta bias von experten?